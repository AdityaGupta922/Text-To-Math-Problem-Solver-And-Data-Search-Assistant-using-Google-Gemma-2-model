...
from langchain.chains import LLMMathChain, LLMChain # LLMMathChain used for math problem solving
from langchain.prompts import PromptTemplate
from langchain_community.utilities import WikipediaAPIWrapper
from langchain.agents.agent_types import AgentType
from langchain.agents import Tool, initialize_agent
from langchain.callbacks import StreamlitCallbackHandler # How the thoughts are displayed in the streamlit app 
...
## Initialize the MAth tool (this is similar to how we did it for the wikipedia_tool)
...
if "messages" not in st.session_state:
    st.session_state["messages"]=[
        {"role":"assistant","content":"Hi, I'm a Maths chatbot who can answer all your maths questions"}
    ]
